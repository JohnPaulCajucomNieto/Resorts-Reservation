...
<head>
    ...
    <link rel="shortcut icon" href="../PICTURE/razon.png" type="image/x-icon">
...
<body>
     <form class="form_container" method="POST" action="../PHP/login.php">
        ...
        <div class="input_container">
          <label class="input_label" for="email_field" name="email_field" >Username</label>
          ...
          <input placeholder="username" title="USERNAME" name="username" type="text" class="input_field" id="email_field">
        </div>
        <div class="input_container">
