...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['SUBMIT'])) {
        ...
        $stmt = mysqli_prepare($con, "UPDATE reservations SET full_name=?, email=?, phone=?, check_in=?, check_out=?, adults=?, children=?, room_type=? WHERE id=?");
        mysqli_stmt_bind_param($stmt, "ssssdsssi", $full_name, $email, $phone, $check_out, $check_in, $adults, $children, $room_type, $id);
...
<body>
    ...
    <div class="container">
        ...
        <form  action="form.php?id=<?php echo $id; ?>" method="post" class="form">
